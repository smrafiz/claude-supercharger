...
# below stays on jq — it pulls the whole of stdout, the large escape-carrying
# value the fast reader is built to refuse — but cwd is a short top-level field
# that was costing a jq fork of its own on every call.
