...
- **What to do** — concrete next step (e.g., "Run `bash ${CLAUDE_PLUGIN_ROOT}/tools/hook-toggle.sh confidence-gate off` for this session, or read the file before editing")
