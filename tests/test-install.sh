...
print(count)
")
# Full mode + developer = 106 hooks total (v2.9.4 +file-lease; commit-check opt-in, not counted)
...
print(count)
")
# standard maps to full = 106 hooks (v2.9.4 +file-lease; with developer, commit-check opt-in)
if [ "$HOOK_COUNT" -eq 106 ]; then
  pass
else
